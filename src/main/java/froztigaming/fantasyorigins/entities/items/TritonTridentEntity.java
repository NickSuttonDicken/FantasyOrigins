package froztigaming.fantasyorigins.entities.items;
...
public class TritonTridentEntity
        extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(TritonTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(TritonTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack tridentStack = new ItemStack(ItemInit.TRITON_TRIDENT);
    ...
    public TritonTridentEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntityInit.TRITON_TRIDENT, owner, world);
