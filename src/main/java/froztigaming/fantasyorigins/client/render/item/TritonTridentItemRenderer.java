package froztigaming.fantasyorigins.client.render.item;
...
public class TritonTridentItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer, SimpleSynchronousResourceReloadListener {
    private final Identifier id;
    private final Identifier tridentId;
    private final Identifier texture;
    private final EntityModelLayer modelLayer;
    private ItemRenderer itemRenderer;
    private TritonTridentEntityModel tridentModel;
    private BakedModel inventoryTridentModel;

    public TritonTridentItemRenderer(Identifier tridentId, Identifier texture, EntityModelLayer modelLayer) {
    ...
    public void reload(ResourceManager manager) {
        ...
        this.tridentModel = new TritonTridentEntityModel(mc.getEntityModelLoader().getModelPart(this.modelLayer));
